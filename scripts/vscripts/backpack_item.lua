...
function PutInBackpack()
    ...
    -- User1 is fired on system too
    DoEntFireByInstanceHandle(GetSystem(), 'FireUser1', '', 0, nil, nil)
end
...
function GetSystem()
    return Entities:FindByName(nil, '@backpack_system')
end

function GetSystemScope()
    return GetSystem():GetPrivateScriptScope()
end
