...
--[[
    `backpack_system/item.lua` is not required for an entity to be stored in the backpack.
    Unlike previous versions of the backpack system, all logic is now handled inside `backpack_system/core.lua`
    ...
    Entity specific functions are now defined in `backpack_system/core.lua` but are listed here for help.
